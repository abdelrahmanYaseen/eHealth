...
<header id="header">
  ...
  <li><a class="active" href="http://localhost/ehealth/DoctorTable.php">Doctor Table</a></li>
                                    ...
                                    <div class="portlet light portlet-fit ">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject font-red sbold uppercase"><center><h1 style="font-family: Times;font-size: 50px;"><br>Doctor Table</h1></center></span>
                                            </div>
    ...
    window.onload = function () {
                ...
                xmlhttp.onreadystatechange = function () {
                    if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                        ...
                        for(jidx=0;jidx<JSONResponse["Result"].length;jidx++){
                            ...
                            DivContent = DivContent + '<td> ' + JSONResponse["Result"][jidx]["Specialization"] + '</td>';
                            DivContent = DivContent + '<td>';
                            DivContent = DivContent + '<a href="http://localhost/ehealth/AddDoctor.php?Operation=Edit&DoctorID=' + JSONResponse["Result"][jidx]["DoctorID"] + '&UserID='+JSONResponse["Result"][jidx]["UserID"] +'">Edit</a>';
                            DivContent = DivContent + '</td>';
                            DivContent = DivContent + '<td>';
                            DivContent = DivContent + '<button type="button" onclick="myFunction(\''+JSONResponse["Result"][jidx]["DoctorID"]+'\',\''+JSONResponse["Result"][jidx]["UserID"]+'\')" id="">Delete</button>';
                            DivContent = DivContent + '</td>';
                            DivContent = DivContent + '</tr>';
      ...
      function myFunction(RecordID,RecordID2) {
        ...
        xmlhttp2.open("POST", url2, true);
                ...
                var params = 'Operation=DeleteDoctor&DoctorID='+ RecordID+'&UserID='+RecordID2;
            console.log(params);
